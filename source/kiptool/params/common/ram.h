...
const Param ramTiming8 = {.name = "RAM Timing 8",
                          ...
                          .measure = NULL,
                          .description = NULL,
                          .offset = ((getOffset(custTable.ramTimingPresetEight)) - (getOffset(custTable.ramTimingPresetOne))) /
                                    4,  // TODO Maybe change table offset logic without increment
                          .length = 4,
...
const Table pMehTable = {.category = RAM,
                         .platform = COMMON,
...
const unsigned int cRAMParamsCount = 3;
const Param *cRAMParams[] = {&commonEmcMemVolt, &eBAL, &eBAS};
const unsigned int cRAMTablesCount = 3;
const Table *cRAMTables[] = {&ramTimingsTable, &pMehTable, &sMehTable};