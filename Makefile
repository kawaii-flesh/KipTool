...
KTVERSION_MINOR := 0
KTVERSION_BUGFX := 0
KTVERSION := \"$(KTVERSION_MAJOR).$(KTVERSION_MINOR).$(KTVERSION_BUGFX)\"
...
CUSTOMDEFINES += -DKT_VER_MJ=$(KTVERSION_MAJOR) -DKT_VER_MN=$(KTVERSION_MINOR) -DKT_VER_BF=$(KTVERSION_BUGFX) -DKT_VER=$(KTVERSION)
